document.addEventListener("DOMContentLoaded",()=>{
    ...
    function refresh(){
        const list_container = document.createElement('tr');
        const list_num = document.createElement("td");
        const list_title = document.createElement("td");
        const list_writer = document.createElement("td");
        const list_view = document.createElement("td");
        const list_date = document.createElement("td");

        const table = document.querySelector('table');
        
        table.appendChild(list_container).append(list_num, list_title, list_writer, list_view, list_date);
